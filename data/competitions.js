    ...
    competitions: [
...

        {
            ...
            rules:  "<p>"
                        ...
                        +"<br>"
                        +"<p>"
                        +"<b style='color: #4C4D64'>Eligibility Criteria</b>"
                            +"<ol style='list-style-type: disc;padding-left:20px;'>"
        ...
        +"</p>"
                        +"</p>",
            eventDescription: "<p>"
                            +"For detailed description view: <em><a href='media/Poster designng Themes.pdf' target= '_blank'>Poster Designing Themes</a></em>"
                            +"</p>",
            rules:  "<p>"
                        +"<b style='color: #4C4D64'>General Rules </b>"
                        +"<ol style='list-style-type: disc;padding-left:20px;'>"
